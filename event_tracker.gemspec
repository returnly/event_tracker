...
Gem::Specification.new do |spec|
  ...
  spec.summary       = %q{Gem for sharing event-tracking functionality between Rails apps}
  ...
  spec.add_dependency 'activerecord', '~> 4.2', '~> 4.2.5'
  spec.add_dependency 'activejob', '~> 4.2', '~> 4.2.5'
